...
#' @param hmmResults.cor PARAM_DESCRIPTION
#' @param tumour_copy PARAM_DESCRIPTION
#' @param logR.column PARAM_DESCRIPTION, Default: 'logR'
#' @param call.column PARAM_DESCRIPTION, Default: 'event'
#' @param chrs PARAM_DESCRIPTION
#' @param outDir PARAM_DESCRIPTION
#' @param plotSegs PARAM_DESCRIPTION, Default: TRUE
#' @param numSamples PARAM_DESCRIPTION, Default: 1
#' @param plotFileType PARAM_DESCRIPTION, Default: 'pdf'
#' @param plotYLim PARAM_DESCRIPTION, Default: c(-2, 2)
#' @param seqinfo PARAM_DESCRIPTION, Default: NULL
#' @param estimateScPrevalence PARAM_DESCRIPTION, Default: FALSE
#' @param maxCN PARAM_DESCRIPTION
...
#' @param outPlotFile PARAM_DESCRIPTION
#' @param plotFileType PARAM_DESCRIPTION, Default: 'pdf'
#' @param logR.column PARAM_DESCRIPTION, Default: 'logR'
#' @param call.column PARAM_DESCRIPTION, Default: 'event'
#' @param seqinfo PARAM_DESCRIPTION, Default: NULL
#' @param plotSegs PARAM_DESCRIPTION, Default: TRUE
#' @param plotYLim PARAM_DESCRIPTION, Default: c(-2, 2)
#' @param estimateScPrevalence PARAM_DESCRIPTION
#' @param main PARAM_DESCRIPTION
#' @param turnDevOn PARAM_DESCRIPTION, Default: TRUE
#' @param turnDevOff PARAM_DESCRIPTION, Default: TRUE
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
#' @examples
#' \dontrun{
...
#' @param plotSegs PARAM_DESCRIPTION, Default: TRUE
#' @param seqinfo PARAM_DESCRIPTION, Default: NULL
#' @param chr PARAM_DESCRIPTION, Default: NULL
#' @param ploidy PARAM_DESCRIPTION, Default: NULL
#' @param geneAnnot PARAM_DESCRIPTION, Default: NULL
#' @param yrange PARAM_DESCRIPTION, Default: c(-4, 6)
#' @param xlim PARAM_DESCRIPTION, Default: NULL
#' @param xaxt PARAM_DESCRIPTION, Default: 'n'
#' @param cex PARAM_DESCRIPTION, Default: 0.5
#' @param gene.cex PARAM_DESCRIPTION, Default: 0.5
#' @param plot.title PARAM_DESCRIPTION, Default: NULL
#' @param spacing PARAM_DESCRIPTION, Default: 4
#' @param cytoBand PARAM_DESCRIPTION, Default: T
...
#' @title FUNCTION_TITLE
#' @description FUNCTION_DESCRIPTION
#' @param correctOutput PARAM_DESCRIPTION
#' @param seqinfo PARAM_DESCRIPTION, Default: NULL
...
#' }
#' @export
#' @rdname plotCorrectionGenomeWide
...
#' @param lambdas PARAM_DESCRIPTION
#' @param nu PARAM_DESCRIPTION
#' @param subclone PARAM_DESCRIPTION, Default: NULL
#' @param copy.states PARAM_DESCRIPTION, Default: 0:6
#' @param ... PARAM_DESCRIPTION
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
#' @examples
